...
number_iteration = 2000  # Define max iteration number
...
def start_pybullet():  # load Tiago in Pybullet
    ...
    #            useFixedBase=True, useMaximalCoordinates=True)
    p.loadURDF('sphere_1cm.urdf', np.array([0.8, 0., 1.0]),  # TODO: Put an object in target postion
               p.getQuaternionFromEuler([0, 0, 0]),
               useFixedBase=True)
