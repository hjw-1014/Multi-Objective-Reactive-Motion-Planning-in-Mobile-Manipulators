...
def visualize_vector_field(min_x=-1.5, min_y=-1.5, max_x=1.5, max_y=1.5):  # TODO: add on 07.21, change on 07.24
    '''
        Plot vector field based on groud truth path which is generated by RRTstar using MoveIt
    '''

    traj = open_json('qtrjs.json')  # Get 2d trajectory generated by MoveIt
    ...
    uv = cascade_control_all_points()  # TODO: Add repulsive potential field
