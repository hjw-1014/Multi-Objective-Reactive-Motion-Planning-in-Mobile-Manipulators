...
def cascade_control_get_n_ddx(xy: list, v_l: list):  ## TODO: added on 08.12, 08.17, 09.08
    ...
    # Based on the current state, calculate the velocity command
    ddx = cep_cascade_control_n_points(xy, v_l, graph_rrt_son, graph_rrt_father)  # TODO: Return n ddx from x points | 09.02, 09.08
