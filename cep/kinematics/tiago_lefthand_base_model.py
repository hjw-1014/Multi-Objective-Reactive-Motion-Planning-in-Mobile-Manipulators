...
urdf_filename = os.path.join(robot_dir, 'tiago_single_with_holoBaseXY.urdf')

link_names = ['X', 'Y', 'arm_1_link', 'arm_2_link', 'arm_3_link', 'arm_4_link', 'arm_5_link', 'arm_6_link', 'arm_7_link']
